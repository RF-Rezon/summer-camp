    ...
    <>
      <div className="container mx-auto pb-10 dash_classes">
        <div>
          ...
          <div className="text-3xl md:text-4xl font-semibold space-y-4 text-end pr-5">
              <p className="text-gray-800 font-semibold uppercase">Ways</p>
            ...
            <p className="text-xl font-medium text-center mx-auto py-6 pt-12 my-20">
            ...
            <div className="uppercase grid grid-cols-1 md:grid-cols-5 gap-10 py-10">
              <motion.div whileHover={{ scale: 1.5, rotate: 2.0}}
                ...
                <p className="text-lg font-medium">4k Video</p>
              </motion.div>
